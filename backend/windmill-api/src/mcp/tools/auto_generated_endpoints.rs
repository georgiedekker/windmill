...
pub fn all_tools() -> Vec<EndpointTool> {
    ...
    EndpointTool {
        ...
        "properties": {
                "path": {
                        "type": "string",
                        "description": "The path where the flow will be created"
                },
                "summary": {
                        "type": "string",
                        "description": "A short summary of what the flow does"
                },
                "description": {
                        "type": "string",
                ...
                "value": {
                        "type": "object",
                        "description": "The flow definition containing modules and configuration. Must include at least a 'modules' array with the flow steps.",
                        "properties": {
                                "modules": {
                                        "type": "array",
                ...
                "schema": {
                        "type": "object",
                        "description": "JSON schema defining the input parameters for the flow"
                },
                "draft_only": {
                        "type": "boolean",
                        "description": "Whether the flow is only a draft"
                },
                "tag": {
                        "type": "string",
                        "description": "Worker group tag for the flow"
                },
                "dedicated_worker": {
                        "type": "boolean",
                        "description": "Whether the flow requires a dedicated worker"
                },
                "timeout": {
                        "type": "integer",
                ...
                "deployment_message": {
                        "type": "string",
                        "description": "Message to associate with this deployment"
                },
                "visible_to_runner_only": {
                        "type": "boolean",
                        "description": "Whether the flow is only visible to runners"
                },
                "on_behalf_of_email": {
                        "type": "string",
                        "description": "Email to execute the flow on behalf of"
                },
                "ws_error_handler_muted": {
                        "type": "boolean",
                        "description": "Whether to mute workspace error handler for this flow"
                }
        },
        "required": [
                "path",
    ...
    EndpointTool {
        ...
        "properties": {
                "path": {
                        "type": "string",
                        "description": "The current path of the flow to update"
                }
        },
        "required": [
                "path"
        ...
        "properties": {
                "path": {
                        "type": "string",
                        "description": "The new path for the flow (can be the same as current path)"
                },
                "summary": {
                        "type": "string",
                        "description": "A short summary of what the flow does"
                ...
                "value": {
                        "type": "object",
                        "description": "The complete flow definition containing modules and configuration",
                        "properties": {
                                "modules": {
                                        "type": "array",
                                        "description": "Array of flow modules/steps"
    ...
    EndpointTool {
        name: Cow::Borrowed("deleteFlow"),
        description: Cow::Borrowed("delete flow"),
        ...
        "properties": {
                "path": {
                        "type": "string",
                        "description": "The path of the flow to delete"
                }
        },
        "required": [
                "path"
        ...
        "properties": {
                "keep_captures": {
                        "type": "boolean",
                        "description": "Whether to keep capture configurations after deleting the flow (default: false)"
                }
        },
        "required": []
})),
